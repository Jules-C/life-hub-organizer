      ...
      <main class="sm:flex">
        ...
        <div class="sm:ml-6">
          <div class="sm:border-l sm:border-gray-200 sm:pl-6">
            ...
            <p class="mt-1 text-base text-gray-500">{{ errorMessage }}</p>
          </div>
...
const errorMessage = computed(() => {
  return route.query.message || 'An unexpected error occurred.';
});

function retryHandler() {
  // If we have a previous route, try to go back to it
  if (route.query.from) {
