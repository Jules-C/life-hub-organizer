    ...
    <nav class="bg-white shadow">
        ...
        <div class="flex justify-between h-16">
          <div class="flex">
            ...
            <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
              ...
              <router-link to="/health/cycle-tracking"
                class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
                :class="{ 'border-primary-500 text-primary-700': isActive('/health') }" v-if="isHealthTrackingEnabled">
                Health
              </router-link>
          ...
          <div class="hidden sm:ml-6 sm:flex sm:items-center">
            ...
            <div class="ml-3 relative">
              ...
              <div v-if="showProfileMenu"
                class="origin-top-right absolute right-0 mt-2 w-auto min-w-[240px] max-w-[320px] rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-10">
                <div class="px-4 py-2 border-b border-gray-200">
      ...
      <div v-if="showMobileMenu" class="sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
          <router-link to="/" class="block pl-3 pr-4 py-2 border-l-4 text-base font-medium"
          ...
          <router-link to="/calendar" class="block pl-3 pr-4 py-2 border-l-4 text-base font-medium"
          ...
          <router-link v-if="isHealthTrackingEnabled" to="/health"
          ...
          <router-link to="/documents" class="block pl-3 pr-4 py-2 border-l-4 text-base font-medium"
...
// Add this log to check if the click handler is firing
function toggleProfileMenu() {
  console.log('Toggle profile menu', showProfileMenu.value);
